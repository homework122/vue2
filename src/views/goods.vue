...
=======
    <el-row :gutter="20">
      <el-col :span="6">
        <div class="grid-content bg-purple">出售中商品</div>
      </el-col>
      <el-col :span="6">
        <div class="grid-content bg-purple">下架商品</div>
      </el-col>
    </el-row>
    <!--分割线-->
...
<<<<<<< HEAD
  ...
  methods: {
    handleClick() {
      if (this.activeName == "chushouzhong") {
        this.$router.push("/home/goods/chushouzhong");
      }
      if (this.activeName == "xiajia") {
        this.$router.push("/home/goods/xiajia");
      }
    }
=======
      true: true,
