...
<template>
  <div>
    ...
    <el-row :gutter="2">
      <el-col :span="3">
        <div class="grid-content bg-purple">
          <el-input v-model="mypost_titleVal" placeholder="广告名称"></el-input>
        </div>
      </el-col>
      <el-col :span="3">
        <div class="grid-content bg-purple">
    ...
    >
      ...
      <el-table-column label="广告链接" prop="adver_link"> </el-table-column>
      <el-table-column label="归属广告位" prop="adver_belong_page">
      </el-table-column>
      <el-table-column label="有效日期" prop="adver_startime">
      </el-table-column>
      <el-table-column label="点击数" prop="adver_hits"> </el-table-column>
      <el-table-column label="状态" prop="mypost_megsum"> </el-table-column>
