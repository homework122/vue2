        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
            ...
            <el-form-item>
                ...
                <el-dialog title="发帖" :visible.sync="fatie">
                    <el-form :model="form">
                        <el-form-item label="帖子主题" :label-width="formLabelWidth">
                            <el-input v-model="form.name" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="类型" :label-width="formLabelWidth">
                            <el-input v-model="form.aa" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="作者" :label-width="formLabelWidth">
                            <el-input v-model="form.aa" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="回复/查看" :label-width="formLabelWidth">
                            <el-input v-model="form.aa" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
                    ...
                    <el-dialog title="" :visible.sync="onxiugai">
                        <el-form :model="formxiugai">
                            <el-form-item label="主题" :label-width="formLabelWidth">
                                <el-input v-model="formxiugai.circle_name" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="类别" :label-width="formLabelWidth">
                                <el-input v-model="formxiugai.circletype_name" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="作者" :label-width="formLabelWidth">
                                <el-input v-model="formxiugai.circle_no" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="回复/查看" :label-width="formLabelWidth">
