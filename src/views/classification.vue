<template>
    <div id="app" class="bg" v-cloak>
        ...
        <el-button style="margin-right: 10px" type="primary" icon="el-icon-search" size="small" @click="query()">查询
        </el-button>
        <!--查询-->
        <el-input
                size="small"
                        ...
                        <el-col :span="14">
                            <div class="grid-content bg-purple">
                                <el-form-item label="上级分类:" style="width: 300px" v-if="readonly!=true"
                                     prop="vall">
                                    <el-select v-model="vall" style="width:300px" elcarable placeholder="上级分类名称"  autocomplete="off">
                                ...
                                <div>
                                    <el-form-item label="分类名称:" style="width: 200px"  prop="comc_name" >
                                        <el-input placeholder="分类名称" style="width: 300px" v-model="comc_name" clearable
                                                  class="width"  autocomplete="off"></el-input>
                                    </el-form-item>
                                </div>
                                <div class="center">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-image style="width: 50px;height: 50px" :src="scope.row.comc_img"></el-image>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            determine() {
                ...
                if (this.a == 1) {
                    // 修改请求数据
                    this.$axios.post('/api/sale/editComc.do', {
            ...
            Delet(val) {
                // 请求数据
                this.$axios.post('/api/sale/delComcs.do', {
