    ...
    <div id="search">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="退款编号">
          <el-input v-model="formInline.infor_no" placeholder="退款编号" size="mini"></el-input>
        </el-form-item>
        <el-form-item label="订单编号">
          <el-input v-model="formInline.order_no" placeholder="订单编号" size="mini"></el-input>
        </el-form-item>
        <el-form-item label="买家昵称">
          <el-input v-model="formInline.client_no" placeholder="买家昵称" size="mini"></el-input>
        </el-form-item>
        <el-form-item label="申请时间" >
          <el-col :span="11">
            <el-form-item prop="date1">
              <el-date-picker type="date" placeholder="开始时间" v-model="formInline.infor_startime" style="width: 100%;" size="mini"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">至</el-col>
          <el-col :span="11">
            <el-form-item prop="date2">
              <el-date-picker placeholder="结束时间" v-model="formInline.infor_endtime" style="width: 100%;" size="mini"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-form-item>
        <el-form-item label="退款状态">
          <el-select v-model="formInline.infor_status" placeholder="退款状态" size="mini">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span>{{scope.row.infor_status | statusForm(scope.row.infor_status)}}</span>
        </template>
      </el-table-column>
      <el-table-column
              prop="address"
  ...
  export default {
    ...
    methods: {
      ...
      getAllInfo(currentPage,pagesize){
        this.$axios.post('/api/refund/queryInformationAll.do',{
      ...
      onSubmit() {
        ...
        // 查询请求数据
        this.$axios.post('/api/refund/queryInformationCondition.do',{
      ...
      handleClick(row) {
        console.log(row);
        // 点击查看的时候将退款状态传递
        this.$router.push({name:"RefundDetail",params:{statusId:row.infor_status,refundId:row.infor_no,sendOrderId:row.order_no}})
