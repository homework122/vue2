...
<template>
  <div>
    ...
    >
      ...
      <el-table-column label="广告尺寸" prop="ad_size"> </el-table-column>
      <el-table-column label="所属页面" prop="adver_belong_page">
      </el-table-column>
      <el-table-column label="播放方式" prop="ad_piay"> </el-table-column>
      <el-table-column label="在线广告数" prop="ad_online"> </el-table-column>
      <el-table-column label="拍期广告数" prop="ad_description">
      </el-table-column>
