<template>
    <div class="bg" v-cloak>
        ...
        <el-button type="primary" size="small" @click="shangJia" :disabled="this.multipleSelection.length === 0">批量下架</el-button>
        <!--新增-->
        <el-button
                type="primary"
                icon="el-icon-plus"
        ...
        <el-button style="margin-right: 10px" type="primary" icon="el-icon-search" size="small" @click="query()"
        >查询
        </el-button>
        <!--查询-->
        <el-select v-model="fenlei" style="width:150px;margin-right: 10px" placeholder="分类名称" size="small">
                    ...
                    <el-col :span="24">
                        ...
                        <el-form label-width="80px">
                            ...
                            <el-form-item label="分类名称">
                                ...
                                <el-button @click="newClassification()" style="margin-left: 30px" type="primary">新增分类</el-button>
                            </el-form-item>
                            <!--分类新增弹出框-->
                            <div>
                                <!--分类新增弹出框-->
                            ...
                            <div @click="qiehuan" v-if="xianshi">
                                <p>点击图片切换</p>
                                图片：
                                <el-image :src="dialogImageUrl" style="width: 200px;height: 100px"></el-image>
                            </div>
                            <div style="width: 60%">
        ...
        <template>
            ...
            >
                ...
                <el-table-column
                        ...
                        width="150">
                    <template slot-scope="scope">
                        <el-image style="width: 50px;height: 50px" :src="scope.row.com_imgs"></el-image>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            switchChange(val){
                console.log('状态')
                console.log(val)
                this.$axios.post("/api/sale/editIsUpper.do",{
                    com_nos:[val.com_no],
            ...
            determine() {
                ...
                this.$axios.post('/api/sale/addComc.do', {
            ...
            submit() {
                for(let i=0;i<this.tabledatas.length;i++){
                    for(var item in this.tabledatas[i]){
                        if(this.tabledatas[i][item].trim()==''){
                            this.$message('产品的规格信息不能为空')
                        }else {
                            if (this.a == 1) {
                                // 添加数据
                                this.$axios.post('/api/sale/addCom.do', {
                                ...
                                // 修改数据
                                this.$axios.post('/api/sale/editCom.do', {
                                    com_no: parseInt(this.ccom_no),
                                    comc_no: parseInt(this.vall),
                                    com_name: this.biaoqian,
                                    com_imgs: this.imgUrl,
            ...
            batchBelete() {
                ...
                console.log(ids);
                this.$axios.post('/api/sale/delCom.do', {
                        com_nos: [ids]
                    },
                    {
                        // 设置请求头
