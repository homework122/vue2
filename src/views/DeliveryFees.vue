  ...
  <div class="DeliveryFees">
    ...
    <div id="searchBox">
      ...
      <div>
        ...
        <el-dialog title="添加配送费模板" :visible.sync="dialogFormVisible" width="100%" lock-scroll="false">
          <el-form :model="form">
            ...
            <el-form-item label="结算方式" :label-width="formLabelWidth">
              ...
              <p style="color: gainsboro;font-size: 15px">使用独立结算模板商品，提交订单时系统自动将所有属于该模板商品归于一个订单结算，不和普通结算商品一起结算。</p>
            </el-form-item>
                      ...
                      <el-row>
                        <div class="sendWay" >
                          <el-form-item label="默认运费:" :label-width="formLabelWidth" class="defaultF" >
                            <el-input v-model="form.name1" autocomplete="off" class="el-input" size="mini"> <i slot="suffix" >件</i></el-input>
                          </el-form-item>
                          <el-form-item label="" :label-width="formLabelWidth">
                            <el-input v-model="form.name2" autocomplete="off" class="el-input" size="mini"><i slot="suffix" >元</i></el-input>
                          </el-form-item>
                          <el-form-item label="每增加" :label-width="formLabelWidth">
                            <el-input v-model="form.name3" autocomplete="off" class="el-input" size="mini"><i slot="suffix" >件</i></el-input>
                          </el-form-item>
                          <el-form-item label="增加运费" :label-width="formLabelWidth">
                            <el-input v-model="form.name4" autocomplete="off" class="el-input" size="mini"><i slot="suffix" >元</i></el-input>
                          </el-form-item>
                        </div>
                      </el-row>
                      <!--配送规则-->
                        ...
                        <el-table
                          ...
                          <el-table-column
                            ...
                            <template slot-scope="scope">
                              <el-select v-model="scope.row.value1" multiple placeholder="请选择">
                                <el-option
                          ...
                          <el-table-column
                                  label="操作">
                            <template slot-scope="scope">
                              <el-button @click="delEachCity(scope.row)">清空</el-button>
                            </template>
                          </el-table-column>
                        </el-table>
                      </el-row>
                  ...
                  <el-collapse-item title="快递物流" name="2">
                    <template >
                      ...
                      <el-row>
                        <div class="sendWay" >
                          <el-form-item label="默认运费:" :label-width="formLabelWidth" class="defaultF" >
                            <el-input v-model="form.name1" autocomplete="off" size="mini"> <i slot="suffix" >件</i></el-input>
                          </el-form-item>
                          <el-form-item label="" :label-width="formLabelWidth">
                            <el-input v-model="form.name2" autocomplete="off" size="mini"><i slot="suffix" >元</i></el-input>
                          </el-form-item>
                          <el-form-item label="每增加" :label-width="formLabelWidth">
                            <el-input v-model="form.name3" autocomplete="off" size="mini"><i slot="suffix" >件</i></el-input>
                          </el-form-item>
                          <el-form-item label="增加运费" :label-width="formLabelWidth">
                            <el-input v-model="form.name4" autocomplete="off" size="mini"><i slot="suffix" >元</i></el-input>
                          </el-form-item>
                        </div>
                      </el-row>
                      <!--配送规则-->
                      <el-row>
                        <el-table
                          ...
                          <el-table-column
                                  label="操作">
                            <template slot-scope="scope">
                              <el-button @click="delEachQuick(scope.row)">清空</el-button>
                            </template>
                          </el-table-column>
                        </el-table>
                      </el-row>
                         ...
                         <el-table-column
                           ...
                           <template slot-scope="scope">
                             <el-select v-model="scope.row.chooseSendWay">
                               <el-option label="同城配送" value="0"></el-option>
                         ...
                         <el-table-column
                           ...
                           <template slot-scope="scope">
                            ...
                            <!--包邮条件-->
                             <div>
                               <span>满</span>
                               <el-input size="mini" v-model="scope.row.ruleFee"></el-input>
                               <span v-if="scope.row.freeCon == 0">件</span><span v-if="scope.row.freeCon == 1">元</span>
                               <span>包邮</span>
                             </div>
                           </template>
                         </el-table-column>
                         <el-table-column
                                 label="操作" width="270px">
                           <template >
                             <div class="refSendOper">
                               <el-button type="success" icon="el-icon-plus" circle @click="addRef()"></el-button>
                               <el-button type="danger" icon="el-icon-minus" circle @click="delRef()" :disabled="tableRefSend.length == 1"></el-button>
                             </div>
            ...
            <div class="sendOper">
              ...
              <el-dialog title="修改模板" :visible.sync="dialogUpdateVisible">
                <el-form :model="formUpdate">
                  <el-form-item label="配送方式" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.sendMethods" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="配送区域" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.sendArea" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="首件个数" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.firstCount" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="默认配送费" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.defaultFee" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="续件(个)" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.renewCount" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="额外配送费" :label-width="formLabelWidth">
                    <el-input v-model="formUpdate.renewFee" autocomplete="off"></el-input>
                  </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
  ...
  export default {
    ...
    methods:{
      ...
      save(){
        ...
        // 请求添加模板
        this.$axios.post('/api/sale/addDistt.do',{
