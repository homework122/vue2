...
<div>
    <div>
        ...
        <p>手机:{{user.user_phone}} <el-button type="primary" @click="upPhone" size="small">修改手机号</el-button></p>
...
<el-form :model="form">
    ...
    <el-input v-model="form.user_name" autocomplete="off"   style="width: 240px"></el-input>
    </el-form-item>
    <el-form-item label="修改邮箱" :label-width="formLabelWidth">
    <el-input v-model="form.user_email" autocomplete="off"   style="width: 240px"></el-input>
    </el-form-item>
    <el-form-item label="修改手机号" :label-width="formLabelWidth"> 
    <el-input v-model="form.user_phone" autocomplete="off"   style="width: 240px"></el-input> <el-button type="primary" @click="countDown" :disabled="disabled">  {{content}}</el-button>
    </el-form-item>
    <el-form-item label="请输入验证码" :label-width="formLabelWidth"> 
    <el-input v-model="form.yzm" autocomplete="off"   style="width: 240px"></el-input>
    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getnew(){
            var that =this
        this.$axios.post("/api/sys/showKeyEmpInfoAbs.do",{
