...
<div>
    ...
    <el-table-column
                ...
                <template slot-scope="scope">
                    <el-image style="width: 50px;height: 50px" :src="scope.row.user_img"></el-image>
                </template>
            </el-table-column>
    ...
    <el-form ref="uptableData" :model="uptableData" :label-width="formLabelWidth">
        <el-form-item label="用户昵称">
        <el-input v-model="uptableData.user_name" disabled style="width:240px"></el-input>
        </el-form-item>
        <el-form-item label="邮箱地址">
        <el-input v-model="uptableData.user_email" style="width:240px"></el-input>
        </el-form-item>
        <el-form-item label="手机号码">
        <el-input v-model="uptableData.user_phone" style="width:240px"></el-input>
        </el-form-item>
        <el-form-item label="密码">
        <el-input v-model="uptableData.user_pwd" style="width:240px" type="password"></el-input>
        </el-form-item>
    ...
    <el-form ref="addtableData" :model="addtableData" :label-width="formLabelWidth">
        <el-form-item label="用户昵称">
        <el-input v-model="addtableData.user_name"  style="width: 240px"></el-input>
        </el-form-item>
        <el-form-item label="邮箱地址">
        <el-input v-model="addtableData.user_email"  style="width: 240px"></el-input>
        </el-form-item>
        <el-form-item label="手机号码">
        <el-input v-model="addtableData.user_phone"  style="width: 240px"></el-input><el-button type="primary" @click="countDown" :disabled="disabled" size="small">  {{content}}</el-button>
        </el-form-item>
        <el-form-item label="验证码">
        <el-input v-model="addtableData.yzm"  style="width: 240px"></el-input>
        </el-form-item>
        <el-form-item label="用户状态">
        <el-checkbox v-model="user_status_checked">是否为超级管理员</el-checkbox>
        </el-form-item>
...
methods: {
    ...
    countDown () {
            ...
            type: "warning"
                ...
                that.$axios.post("/api/user/sendSMS.do",{
    ...
    transformation(){
        ...
        this.role_no_checked?this.admin_role_no=1:this.admin_role_no=2
        this.user_status_checked?this.admin_user_status=1:this.admin_user_status=0
    ...
    var that = this;
        if(this.user.user_name==t.user_name&&this.user.user_no==t.user_no){
