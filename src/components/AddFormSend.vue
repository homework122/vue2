<template>
  ...
  <div>
    ...
    <el-dialog title="添加配送费模板" :visible.sync="dialogFormVisible" width="100%" lock-scroll center>
      <el-form :model="addForm">
        <el-form-item label="模板名称" :label-width="formLabelWidth">
          <el-input v-model="addForm.name" autocomplete="off" style="width: 300px" class="formMarginLeft"></el-input>
        </el-form-item>
        ...
        <el-form-item label="配送方式" :label-width="formLabelWidth">
          <el-collapse v-model="activeNames" @change="handleChange" class="formMarginLeft">
            <!--同城配送-->
                    ...
                    <el-table
                      ...
                      <el-table-column
                        ...
                        <template slot-scope="scope">
                          <el-select v-model="scope.row.dispm_address" multiple placeholder="请选择">
                            <el-option
                      ...
                      <el-table-column
                              ...
                              width="180">
                        <template slot-scope="scope">
                          <el-input v-model="scope.row.dispm_addfreight"></el-input>
                        </template>
                      </el-table-column>
                      <el-table-column
                              label="操作" width="180">
                        <template slot-scope="scope">
                          ...
                          <el-button @click="addEachCity(scope.$index,scope.row)" >保存</el-button>
                        </template>
                      </el-table-column>
                    </el-table>
                  </el-row>
                    ...
                    <el-table
                      ...
                      <el-table-column
                        ...
                        <template slot-scope="scope">
                          ...
                          <el-button @click="addEachQuick(scope.$index,scope.row)">保存</el-button>
                        </template>
                      </el-table-column>
                    </el-table>
                  </el-row>
                  ...
                  <el-row v-if="checked3">
                    <el-table
                      ...
                      <el-table-column
                              ...
                              width="270px">
                        <template slot-scope="scope">
                          <el-select v-model="scope.row.value1" multiple placeholder="请选择" @change="juadgeFreeAddre(scope.row.value1)">
                            <el-option
                                    v-for="item in areaOptions"
                                    :key="item.area_no"
                                    :label="item.area_name"
                      ...
                      <el-table-column
                              ...
                              width="270px">
                        <template slot-scope="scope">
                          <el-select v-model="scope.row.free_method" @change="judgeSendWay(scope.row)">
                            <el-option label="请选择" value=""></el-option>
                            <el-option label="同城配送" value="同城配送"></el-option>
                            <el-option label="快递物流" value="快递物流"></el-option>
                          </el-select>
                        </template>
                      </el-table-column>
                      <el-table-column
                              ...
                              width="270px">
                        <template slot-scope="scope">
                          <el-select v-model="scope.row.free_condi" @change="judgeConMoney(scope.row)">
                          ...
                          <div v-if="scope.row.free_condi == 0">
                            <span>满</span>
                            <el-input size="mini" v-model="scope.row.free_pies" @change="judgeConCount(scope.row)"></el-input>
                            <span >件</span>
                            <span>包邮</span>
                          </div>
                          <div v-if="scope.row.free_condi == 1">
                            <span>满</span>
                            <el-input size="mini" v-model="scope.row.free_money" @change="judgeConCount"></el-input>
                            <span>元</span>
                            <span>包邮</span>
                          </div>
                        </template>
                      ...
                      <el-table-column
                        ...
                        <template slot-scope="scope">
                          <div class="refSendOper">
                            ...
                            <el-button type="danger" icon="el-icon-minus" circle @click="delRef(scope.row)" :disabled="addForm.youRule.length == 1"></el-button>
                            <!--保存当前包邮条件-->
                          </div>
