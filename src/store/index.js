...
export default new Vuex.Store({
  state: {
    ...
    tabIndex:window.sessionStorage.getItem("tabIndex")?window.sessionStorage.getItem("tabIndex"):"",
    editableTabsValue:window.sessionStorage.getItem("editableTabsValue")?window.sessionStorage.getItem("editableTabsValue"):"",
